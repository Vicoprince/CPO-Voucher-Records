                            ...
                            if(mysqli_num_rows($searchresult)<1) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan= 3><a href="project-info.php?id=<?php echo $data['id']; ?>"><button class="action-view">View</button></a> / <a href="project-update.php?id=<?php echo $data['id']; ?>"><button class="action-update">Update</button></a> / <a href="project-delete.php?id=<?php echo $data['id']; ?>"><button class="action-delete">Delete</button></a></td>
                                    </tr>
                                </tbody>
