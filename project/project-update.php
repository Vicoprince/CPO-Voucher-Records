<?php 
    ...
    if (isset($_GET["id"])) {
        $updateid = $_GET["id"];
        $updatequery = "SELECT * FROM `project` WHERE id = '$updateid' ";
...
<head>
    ...
    <title>P R O J E C T | Update Record</title>
...
<?php 
    ...
    // $id = $_SESSION['id'];
     ...
     if (isset($_POST['update'])) {
        ...
        $updatequery = "UPDATE `project` SET `Beneficiary`= '$Ubeneficiary', `Amount`= '$Uamount',`treasury_no`= '$Utnum',`voucher_no`= '$Uvnum',`receipt_no`= '$Urnum',`are_receipts_ok`= '$Uare_receipts_ok',`is_narration_ok`= '$Uis_narration_ok',`is_account_changed`= '$Uis_amount_changed',`Batch_no`= '$Ubatch_no', `transaction_type`= '$Utransaction_type', `are_signatures_ok`= '$Uare_signatures_ok',`are_assets_included`= '$Uare_assets_included',`is_cert_of_honour_ok`= '$Uis_cert_honour',`is_voucher_paid_in_insttalments`= '$Uvoucher_instalment',`is_voucher_fully_paid`= '$Uvoucher_fully_paid',`voucher_payment_outstanding`= '$Uvoucher_outstanding',`voucher_payment_full`= '$Uvoucher_payment_full',`voucher_to_copy_list`= '$Uvoucher_copy',`are_receipts_stamped`= '$Uare_receipts_stamped',`is_voucher_retired`= '$Uvoucher_retired' WHERE id = '$id'";
