    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="form-container">
                <form action="rfa_search.php" method="POST">
                            ...
                            if(mysqli_num_rows($searchresult)<1) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan= 3><a href="info.php?id=<?php echo $data['id']; ?>"><button class="action-view">View</button></a> / <a href="update.php?id=<?php echo $data['id']; ?>"><button class="action-update">Update</button></a> / <a href="rfa-delete.php?id=<?php echo $data['id']; ?>"><button class="action-delete">Delete</button></a></td>
                                    </tr>
                                </tbody>
