                            ...
                            if(mysqli_num_rows($searchresult)<1) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan= 3><a href="info.php?id=<?php echo $data['id']; ?>"><button class="action-view">View</button></a> / <a href="update.php?id=<?php echo $data['id']; ?>"><button class="action-update">Update</button></a> / <a href=""><button class="action-delete">Delete</button></a></td>
                                    </tr>
                                </tbody>
