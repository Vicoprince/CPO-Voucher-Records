        ...
        <div class="content">
            ...
            <div class="form-container">
                <div class="button-link-container">
                        <a href="./tsa_search.php"><button class="return-button">Back</button></a>
                    
                        <a href="tsa_update.php?id=<?php echo $_SESSION['uid']; ?>"><button class="update-button">Update Record</button></a>
                </div>
                ...
                <?php 
                    ...
                    $query = "SELECT * FROM `tsa` WHERE `id` = '$id'";
