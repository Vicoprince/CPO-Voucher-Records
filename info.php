        ...
        <div class="content">
            ...
            <div class="form-container">
                <div class="button-link-container">
                        <a href="./rfa_search.php"><button class="return-button">Back</button></a>
                    
                        <a href="update.php?id=<?php echo $_SESSION['uid']; ?>"><button class="update-button">Update Record</button></a>
                </div>
